...
13. **⚠️ ΠΡΟΣΦΟΡΕΣ — ΠΡΟΧΕΙΡΕΣ**: οι 4 προσφορές γράφτηκαν από εμάς ως προτάσεις,
    με βάση τις υπηρεσίες που ήδη προσφέρει. **Καμία δεν έχει τιμή** — δεν θα
    βάζαμε ποτέ τιμές που δεν μας δόθηκαν. Χρειάζεται από την κ. Σπυριδάκη:
    ποιες προσφορές θέλει πραγματικά, τι περιλαμβάνει η καθεμία και **τις τιμές**.
    Μέχρι τότε η σελίδα λέει «τηλεφωνήστε μας για την τιμή».
